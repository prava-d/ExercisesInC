/* Code from Head First C.
    ...
    Modified from the provided wiki_client.c file
    Changed socket port and deleted unecessary lines in main function
    Also changed the advice in the server class. :)
*/
