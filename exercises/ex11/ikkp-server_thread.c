...
Modified once more by Prava. :) But only to add forks, nothing weird.
...
// Split up the main into two functions to add threading functionality
void *serve (void *arg) {
...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        ...
        if (pthread_create(&t, NULL, serve, (void *) connect_d) != 0) {
            error("NO THREAD FOR YOU");
        }        
    }
    return 0;
}
